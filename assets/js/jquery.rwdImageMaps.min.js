...
<html lang="en">
  ...
  <title>jQuery-rwdImageMaps/jquery.rwdImageMaps.min.js at master · stowball/jQuery-rwdImageMaps</title>
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MjQ5OTI2MzI2OjQ4MWU2ZGNmNzVlMjhlNDdkNTM2MDA0MDE1NjQwZjdjMTI1NWU4ZWM0ODNkYTdlYTg5ZmRkN2ZjOGQyMjk3MTM=--d76c61477a172543c313c6ccbbd497f46eb5d65a">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="E88F:6E08:70D2AC:CA4975:5A904673" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="E88F:6E08:70D2AC:CA4975:5A904673" name="octolytics-dimension-request_id" /><meta content="iad" name="octolytics-dimension-region_edge" /><meta content="iad" name="octolytics-dimension-region_render" /><meta content="36533117" name="octolytics-actor-id" /><meta content="rmayston" name="octolytics-actor-login" /><meta content="2e076937b734fe6713a3090d1281e4a278c1a5caa583463fc7cb70106634ba1c" name="octolytics-actor-hash" />
...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="rmayston">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="NjAwM2FlMDMyYWQxNWU0YTAwNTY5YTZkNGU0YzdhNDRiYTA5M2VlZDhhNGNhYzZiMDU3YTE3MWFlOWJhODViNHx7InJlbW90ZV9hZGRyZXNzIjoiODkuMTk3LjQuMTE4IiwicmVxdWVzdF9pZCI6IkU4OEY6NkUwODo3MEQyQUM6Q0E0OTc1OjVBOTA0NjczIiwidGltZXN0YW1wIjoxNTE5NDA0NjcwLCJob3N0IjoiZ2l0aHViLmNvbSJ9">
  ...
  <meta name="html-safe-nonce" content="42f269c042f9086f6289ea304baba34519019e66">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <div class="dropdown-header">
    <span title="stowball/jQuery-rwdImageMaps">This repository</span>
  </div>
    <a class="dropdown-item" href="/stowball/jQuery-rwdImageMaps/issues/new" data-ga-click="Header, create new issue">
      New issue
    </a>
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@rmayston" class="avatar float-left mr-1" src="https://avatars1.githubusercontent.com/u/36533117?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>

      <ul class="dropdown-menu dropdown-menu-sw">
        <li class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">rmayston</strong>
        </li>

        <li class="dropdown-divider"></li>

        <li><a class="dropdown-item" href="/rmayston" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a></li>
        <li><a class="dropdown-item" href="/rmayston?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a></li>
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="nTTaKr6dnsXoSk358zB5fKiGWY4qIVlWCdLubVoIHkdQhUebtXkM59Lm/JRRH/tx3pyW3aBpOyC6Y746h4Tn/g==" /></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Niccs+iUMUB0cZ6HcDlkZ3/cz50CvUvadBOcIRJO4e/7loEC43CjYk7dL+rSFuZqCcYAzoj1KazHosx2z8IYVg==" /></div>
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="uCCy9dZdEi/mvYEK+YHfiL6zrXsz9cC99QkTMXy4AF/+asmb7S/qMlOCoHAe+tbmG4qPKwgcIj4Z9JFRN0owhA==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="4030134" />

        <div class="select-menu js-menu-container js-select-menu">
          <a href="/stowball/jQuery-rwdImageMaps/subscription"
          ...
          <a class="social-count js-social-count"
            href="/stowball/jQuery-rwdImageMaps/watchers"
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/stowball/jQuery-rwdImageMaps/unstar" class="starred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="l8bXbMJDPTAl/mOfReS4dfSi7/9XGmGDDtJno+cCPbC2h/KJsKdLP+MJLeeY1AKjc1hkC2jWn+BWvMW7r84djg==" /></div>
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
        aria-label="Unstar this repository" title="Unstar stowball/jQuery-rwdImageMaps"
        ...
        <a class="social-count js-social-count" href="/stowball/jQuery-rwdImageMaps/stargazers"
           aria-label="1223 users starred this repository">
          1,223
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/stowball/jQuery-rwdImageMaps/star" class="unstarred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="msa8lm+mvVdpirlN1jLdJIJ9w3t7z0dBdy0+Tmwjknq07+mhGmmmHt9G59KM6zEj4EvrufKGElCiPmz1122lmg==" /></div>
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
        aria-label="Star this repository" title="Star stowball/jQuery-rwdImageMaps"
  ...
  <li>
          <a href="#fork-destination-box" class="btn btn-sm btn-with-count"
              title="Fork your own copy of stowball/jQuery-rwdImageMaps to your account"
              aria-label="Fork your own copy of stowball/jQuery-rwdImageMaps to your account"
              rel="facebox"
          ...
          <div id="fork-destination-box" style="display: none;">
            ...
            <include-fragment src=""
                ...
                data-url="/stowball/jQuery-rwdImageMaps/fork?fragment=1">
              <img alt="Loading" height="64" src="https://assets-cdn.github.com/images/spinners/octocat-spinner-128.gif" width="64" />
            </include-fragment>
          </div>

    <a href="/stowball/jQuery-rwdImageMaps/network" class="social-count"
       aria-label="515 users forked this repository">
      515
    </a>
  </li>
</ul>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/stowball/jQuery-rwdImageMaps/pulls" class="js-selected-navigation-item reponav-item" data-hotkey="g p" data-selected-links="repo_pulls checks /stowball/jQuery-rwdImageMaps/pulls" itemprop="url">
    ...
    <a href="/stowball/jQuery-rwdImageMaps/wiki" class="js-selected-navigation-item reponav-item" data-hotkey="g w" data-selected-links="repo_wiki /stowball/jQuery-rwdImageMaps/wiki">
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <!-- blob contrib key: blob_contributors:v21:6401118ac16017ad0a9743033b0245b4 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
    ...
    <div class="breadcrumb js-zeroclipboard-target">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a href="/stowball/jQuery-rwdImageMaps" data-pjax="true"><span>jQuery-rwdImageMaps</span></a></span></span><span class="separator">/</span><strong class="final-path">jquery.rwdImageMaps.min.js</strong>
    </div>
  </div>
    ...
    <div class="BtnGroup">
      ...
      <a href="/stowball/jQuery-rwdImageMaps/commits/master/jquery.rwdImageMaps.min.js" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
        ...
        <a class="btn-octicon tooltipped tooltipped-nw"
          ...
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/stowball/jQuery-rwdImageMaps/edit/master/jquery.rwdImageMaps.min.js" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="E1m8X8ZBNg7Ibpd5ybLSgFntb+6ZSQhs9qlm+SzSFLcR0y/dQwkLVliDbL5V0uOTMWWrl8oAxhZ2rIa0MaggHQ==" /></div>
            <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
              aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
              <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
            </button>
</form>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/stowball/jQuery-rwdImageMaps/delete/master/jquery.rwdImageMaps.min.js" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="7cMdHPxq7luHkqUHukaKGDNeDasWd4KoDcVR6/sa6Nz0frLElbJb4Ppaix+fREefsqSnBvYVWqzLQNOdKKZ1Iw==" /></div>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between py-6 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.19791s from unicorn-1416332274-s6fh5">GitHub</span>, Inc.</li>
  ...
  <div id="ajax-error-message" class="ajax-error-message flash flash-error">
    ...
    <script async="async" crossorigin="anonymous" integrity="sha512-/Wio0ViQkQxBcTAeIDeJE12HntFJH/G1VTG090OXX2V4Q1GoSUVJmGfBAh33gEGoS7RInDIt8jq2QwS13tbPog==" src="https://assets-cdn.github.com/assets/github-fd68a8d15890.js" type="application/javascript"></script>
